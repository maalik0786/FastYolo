	...
	public static class ExceptionExtensions
	{
		...
		private static bool IsWeakException(Exception ex)
		{
			return ex is ArgumentNullException || ex is NullReferenceException ||
			       ...
			       ex is IndexOutOfRangeException || ex != null && ex.GetType().Name.Contains("Register");
		}

		/// <summary>
		///   Not a constant or define to avoid compiler warnings with unused code, just a static field.
		/// </summary>
